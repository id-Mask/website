  ...
  <div>
    <n-space justify="center" :size="[100, 50]" style="text-align: center;">
      ...
      <div>
        ...
        <n-divider />
        <n-space vertical>
          <n-button quaternary type="tertiary" tag="a" href="https://github.com/id-Mask" target="_blank">
            <n-icon size="20">
    ...
    <n-space justify="center" size="small" style="text-align: center; cursor: pointer;" vertical @click="updateStatus()">
      <div>
        <n-text depth="3" style="font-size: 90%;">zkOracle status </n-text>
      ...
      <div>
        <n-text depth="3" style="font-size: 90%;">GraphQL status </n-text>
